...
plant2=Plant.create!(user: user, name: "Sunflower", price: 3, address: "Rua Pedra Azul, 76, São Paulo - SP", description: "She is a plant capable of generating sun over time, allowing the player to plant additional plants with ease.", quantity: 1)
plant3=Plant.create!(user: user, name: "Cherry Bomb", price: 10, address: "Avenida Prof. Fonseca Rodrigues, 2001, São Paulo - SP", description: "When planted, Cherry Bomb explodes violently in a 3x3 area, dealing 1800 damage per shot to any zombies that happen to be near or caught in the blast. This is enough to instantly kill almost all zombie(s).", quantity: 1)
plant4=Plant.create!(user: user, name: "Wall-nut", price: 4, address: "Praça da Luz, 2, São Paulo - SP", description: "Is the first defensive plant obtained Plants vs. Zombies and is the fourth plant unlocked overall. He acts as a shield for the player's other plants, as he has high durability. He is mainly used to stall or block zombies in order to buy time for the player to plant an offensive plant, or for offensive plants to take out zombies with high health.", quantity: 1)
plant5=Plant.create!(user: user, name: "Chomper", price: 6, address: "Rua Galvão Bueno, 72, São Paulo - SP", description: "Is the first defensive plant obtained Plants vs. Zombies and is the fourth plant unlocked overall. He acts as a shield for the player's other plants, as he has high durability. He is mainly used to stall or block zombies in order to buy time for the player to plant an offensive plant, or for offensive plants to take out zombies with high health.", quantity: 1)
plant6=Plant.create!(user: user, name: "Snow Peashooter", price: 5, address: "Avenida Miguel Estéfno, 3031, São Paulo - SP", description: "Attacks by firing frozen peas at zombies, which can slow their target's movement and attack speed by 50% and deal damage. However, Torchwood can melt them, which will make them into normal peas which removes the freezing effect, so it is not recommended to use a Torchwood with a Snow Pea.", quantity: 1)
